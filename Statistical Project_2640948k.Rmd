...
```{r assump, echo=FALSE, fig.pos = 'H', fig.cap = "\\label{fig:assump} Figure 1: Assumption Checking Plot"}
par(mfrow = c(2, 2))
plot(Pok.Gamma)
```
