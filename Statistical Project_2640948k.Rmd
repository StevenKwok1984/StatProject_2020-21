...
Gamma distribution was applied due to several reasons. To begin with, all of the variables inside data set were positive. Gamma distribution, in reality, is designed for positive values (Julian Faraway, 2016).
