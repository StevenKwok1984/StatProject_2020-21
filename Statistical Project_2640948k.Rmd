...
According to the previous summary and plot 1, the response variable is continuous, and the data do not suggest evidence for applying a specific distribution. polynomial model, therefore, was applied. The details were discussed on the next session.
