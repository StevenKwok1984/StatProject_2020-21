...
```{r echo=FALSE, , fig.pos = 'H', fig.align = "canter", fig.dim = c(10, 9), fig.cap="Plot 1: Scatter plot of data distribution"}
ggpairs(Pok_Grouped)
```

```{r echo=FALSE, , fig.pos = 'H', fig.align = "canter", fig.dim = c(8, 8), fig.cap="Plot 2: Boxplots of Gender vs 4 other variables"}
par(mfrow = c(2, 2))
...
```{r echo=FALSE, , fig.pos = 'H', fig.align = "canter", fig.dim = c(8, 8), fig.cap="Plot 3: Boxplots of Education level vs 4 other variables"}
par(mfrow = c(2, 2))
...
Polynomial linear regression model, based on linear regression model, is a model combinning interactions between variables (Abhigyan, 2020).
...
```{r assump, eval=FALSE, fig.pos='H', include=FALSE}
# assumption checking
par(mfrow = c(2, 2))
plot(Final_Pok.Linear)
```
According to figure 2, there is no obvious positive or negative relations between residuals and fitted values. The final model is:

$PhysicalActivity = 6.136942 + 0.012821*age - 0.279905*education + 0.278323*Gender - 1.761775*Attitude - 0.198716*PokemonGo_AppUsage + 0.973577*PokemonGo_Relate.Behaviour + 0.155076*Attitude^2 - 0.046845*PokemonGo_Relate.Behaviour^2 - 0.003554*(age*education) + 0.085761*(education*Attitude)$
